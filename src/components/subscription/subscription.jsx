...
import { Container, Row, Col, Button, Card } from 'react-bootstrap';import "./subscription.css";
  ...
  return (
    ...
    <Container fluid className="forgot-container d-flex justify-content-center align-items-center">
      ...
      <div className="Rectangle">
        ...
        <p className="start">
          ابدأ رحلتك نحو الاستقلال المالي مع باقاتنا المصممة خصيصاً لاحتياجاتك
        </p>
        ...
        <Col md={4} className="plan-col">
          <Card className="plan-card free-plan">
            <Card.Body>
              ...
              <Button variant="outline-primary" className="subscribe-btn">ابدأ مجاناً</Button>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col md={4} className="plan-col">
          ...
          <Card className="plan-card premium-plan">
            ...
            <Card.Body>
              ...
              <Button variant="light" className="subscribe-btn">اشترك الآن</Button>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col md={4} className="plan-col">
          <Card className="plan-card pro-plan">
            <Card.Body>
              ...
              <Button variant="primary" className="subscribe-btn">اشترك الآن</Button>
            </Card.Body>
          </Card>
        </Col>
      </section>
