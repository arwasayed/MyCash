...
const { joinChallenge, completeChallenge, getActiveChallenges, createChallenge, getAllChallenges, updateChallenge, deleteChallenge } = require('../Controllers/challenge');
